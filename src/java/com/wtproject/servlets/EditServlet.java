...
import com.wtproject.entities.Message;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Users user =(Users)s.getAttribute("currentUser");
                    ...
                    String oddFile= user.getProfile();
            ...
            if(ans)
            {
                ...
                String pathOldFile=request.getRealPath("/")+"picture"+File.separator+ oddFile;
                  if(!oddFile.equals("default.png"))
